...
return array(
	'title'      => __( 'Boxed pricing plans', 'neve-fse' ),
...
<h2 class="has-text-align-center">' . __( 'Pricing Plans', 'neve-fse' ) . '</h2>
<!-- /wp:heading -->
...
<h3 class="has-text-align-center">' . __( 'Starter', 'neve-fse' ) . '</h3>
<!-- /wp:heading -->
...
<a class="wp-block-button__link wp-element-button">' . __( 'Buy Plan', 'neve-fse' ) . '</a>
</div>
<!-- /wp:button -->
</div>
<!-- /wp:buttons -->
...
<p class="has-text-align-center">' . __( 'One website', 'neve-fse' ) . '</p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"align":"center"} -->
<p class="has-text-align-center">' . __( 'Premium Support', 'neve-fse' ) . '</p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"align":"center"} -->
<p class="has-text-align-center">' . __( '20 actions', 'neve-fse' ) . '</p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"align":"center"} -->
<p class="has-text-align-center">' . __( 'Limited access to library', 'neve-fse' ) . '</p>
<!-- /wp:paragraph -->
</div>
<!-- /wp:group -->
</div>
...
<div class="wp-block-group">
<!-- wp:heading {"textAlign":"center","level":3} -->
<h3 class="has-text-align-center">' . __( 'Expert', 'neve-fse' ) . '</h3>
<!-- /wp:heading -->
...
<!-- wp:paragraph {"align":"center"} -->
<p class="has-text-align-center">' . __( 'All plans come with a 14-day money-back guarantee', 'neve-fse' ) . '</p>
<!-- /wp:paragraph -->
</div>
<!-- /wp:group -->
</div>
